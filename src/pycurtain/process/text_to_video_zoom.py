...
def __zoom_imgs_to_video(imgs: List[Image.Image], transition_seconds: int = 4, fps: int = 64, flip_order=False, file_name: str = "output.mp4"):
...
def zoom_in(prompts: List[str], source: SourceImageType, n_imgs: int, file_name: str = "output.mp4"):
